                ...
                <TimelineItem>
                    ...
                    <TimelineContent>
                        ...
                        <p className={style.welcomeGreet}>
                            In this hour you will learn about today’s topic through a live sessions
                            from our highly qualified lecturer. Go through the pre-lecture content.
                            It will help you in understanding the lessons in the lecture better.
                        </p>
                    </TimelineContent>
                </TimelineItem>
                <TimelineItem>
                    ...
                    <TimelineContent>
                        ...
                        >
                            <AccordionSummary
                                ...
                                id="panel1bh-header"
                            >
                                <Typography>Live lecture session!</Typography>
                            </AccordionSummary>
                            ...
                            <AccordionDetails>
                                ...
                                <Typography>
                                    In this hour you will learn about today’s topic through a live
                                    sessions from our highly qualified lecturer.
                                </Typography>
                    ...
                    <TimelineContent>
                        ...
                        >
                            <AccordionSummary
                                ...
                                id="panel1bh-header"
                            >
                                <Typography>Extra Reference Material!</Typography>
                            </AccordionSummary>
