...
export default function Assignment() {
    ...
    const handlePanelChange = (panel) => {
        router.push(
            `/class/room?tab=${router.query.tab}&panel=${panel}&qt=${router.query.qt || "default"}`,
            false,
            {
                scroll: false,
                shallow: true,
                ...
                <TimelineItem>
                    ...
                    <TimelineContent>
                        ...
                        <p className={style.welcomeGreet}>
                            Please solve the assignment below.
                            <br />
                            You can Ask TA for help in case you are stuck or Seek Help from your
                            peers while solving the assignment.
                        </p>
                    </TimelineContent>
                </TimelineItem>
                <TimelineItem>
                        ...
                        >
                            ...
                            >
                                <Typography>
                                    ...
                                    <button className={assignmentStyle.helpRequestButton}>
                                        <QuestionAnswerIcon fontSize="small" /> Help Requests:
                                        Raised-0 / Resolved-0{" "}
                                    </button>
                                </Typography>
                            </AccordionSummary>
                            ...
                            <AccordionDetails>
                                <Typography
                                    color="textSecondary"
                                    variant="h5"
                                    className={classes.liveLectureHeading}
                                >
                                    Assignment Instructions!
                                </Typography>
                                ...
                                <div>
                                    <ul>
                                        <li>
                                            ...
                                            plagiarism, and flagged solutions might not be counted
                                            towards the total score.
                                        </li>

                                        <li>
                                            Do not hesitate to discuss the solution with your
                                            batchmates, or take help from your TAs to build
                                            intuition.
                                        </li>
                                        <li>
                                            DO NOT move on from a problem until you have understood
                                            the approach very well.
                                        </li>
                                        <li>
                                            Plagiarism would defeat the purpose of learning a new
                                            pattern and concept.
                                        </li>
                                    </ul>
                                </div>
