...
function getDuration(time) {
    ...
    else if (sec < 60 * 60) return `${parseInt(sec / 60)} min ago`;
    else if (sec < 60 * 60 * 24) return `${parseInt(sec / (60 * 60))} hr ago`;
...
function Update({ heading, info, time }) {
    ...
    return (
        <Grid item xs={12} className={classes.updateItem}>
...
const data = [
    {
        ...
        info:
            "Congratulations Amitrajit Bose from October EliteX on getting an offer from Flipkart Internet Pvt Ltd",
        time: 1619237839597,
    },
    {
...
export default function LiveUpdates() {
    const classes = useStyles();
    return (
        <Grid container spacing={1} className={classes.updateContainer}>
            <Typography color="textSecondary" variant="h5" component="p" align="center">
                Live Updates
            </Typography>
